...
//  ps：由于这两个接口携带的参数参不多  唯一区别就是有没有id 所以可以把这两个接口封装为一个接口
//这个接口既可以修改品牌，也可以添加品牌，唯一区别的就是调用这个接口的时候，带不带id 带就是修改 不带就是添加
...
//删除品牌/admin/product/baseTrademark/remove/{id} delete 携带一个参数 id
